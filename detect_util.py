...
def drawRectsInface(imagem):
    ...
    faces = cv2.CascadeClassifier('haarcascade_frontalface_default.xml').detectMultiScale(mask_cinza, 1.3, 5)
    for (x, y, w, h) in faces:
        ...
        olhos = cv2.CascadeClassifier('haarcascade_eye.xml').detectMultiScale(rosto_cinza)
